...
Implementación aditiva del event store privado IAM-10 V1 y sus ocho transiciones aprobadas. No se modificaron Flutter, Web, Edge Functions, IAM-5 helpers, workflows n8n comerciales ni contratos operativos comerciales. Se creó por solicitud un workflow temporal de QA direct-PG, inactivo y sin endpoint externo; IAM-1..9 permanecen fuera del alcance, salvo instrumentar sus transiciones aprobadas.
