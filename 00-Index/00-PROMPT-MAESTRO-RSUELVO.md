...
> **Versión:** 1.7 · **Fecha:** 2026-09-15 · **Estado:** ✅ Consistencia 100% certificada entre módulos
> **Changelog v1.7:** D16 — ruteo con número universal (M1 SKU→comercio+sucursal + M2 contexto; links/memoria/remodelo descartados; fallback al canal)
...
| **D16** | **Ruteo con número universal RSUELVO**: un solo WhatsApp para todos los comercios. SKU→(comercio+sucursal) vía `fn_resolver_sku_universal` (tienda global única; sucursal por fila única de inventario, stock-first en legacy compartidos); no-SKU vía `fn_contexto_por_telefono` (pendientes→recencia→pregunta); STOP siempre primero; fallback total al camino por canal (WF-04). Link-codes, memoria persistente y remodelo de `tbl_canal_whatsapp`: descartados por irrelevantes | decisión del dueño 2026-09-15 · `01-Arquitectura/DISENO-D16-Ruteo-Universal.md` v1.0 |
| **D17** | **Altas por staff con aprobación**: SysAdmin/Soporte crean comercios con dueño en estado **pendiente de aprobación**; solo SuperAdmin autoriza (web+móvil). Autocontenido: D4 (alta self-service→ACTIVO) intacto. Implementación pendiente: mecanismo de pendiente en `estado_comercio` o tabla de solicitudes; queda fuera del lote F8-58/61 | decisión del dueño 2026-09-15 · roles expandidos |
